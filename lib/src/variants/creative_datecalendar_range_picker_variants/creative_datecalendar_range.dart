...
import 'package:creative_datecalendar/src/components/custom_tab_bar.dart';
import 'package:creative_datecalendar/src/components/time_picker_spinner.dart';

import '../../../creative_datecalendar_picker.dart';

class CreativeDatecalendarRange extends StatefulWidget {
  const CreativeDatecalendarRange({
    super.key,
  ...
  @override
  State<CreativeDatecalendarRange> createState() =>
      _CreativeDatecalendarRangeState();
}

class _CreativeDatecalendarRangeState extends State<CreativeDatecalendarRange>
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          if (widget.type == CreativeDateCalendarPickerType.dateAndTime)
            Padding(
