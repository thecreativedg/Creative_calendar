...
import 'package:creative_datecalendar/src/variants/creative_datecalendar_range_picker_variants/creative_datecalendar_range.dart';

import '../creative_datecalendar_picker.dart';

class CreativeDateCalendarRangePicker extends StatelessWidget {
  const CreativeDateCalendarRangePicker({
    super.key,
    ...
    return Dialog(
      ...
      shape: Theme.of(context).useMaterial3
          ...
          : borderRadius != null
              ...
              : null,
      child: CreativeDatecalendarRange(
